...
public final class TGEntities {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<SimpleTrailProjectile>> SIMPLE_ITEM_MODEL_PROJECTILE = ENTITIES.register("simple_item_model_projectile", () -> EntityType.Builder.<SimpleTrailProjectile>of(SimpleTrailProjectile::new, MobCategory.MISC)
