...
public class TGItems {
    ...
    public static final DeferredItem<BaseGun> SHOTGUN = GUNS.registerItem("shotgun", properties -> new BaseGun(properties, 15, 4.8f, 0.9f, 0.375f, 0.04f, ModRarity.LIGHT_RED)); // 霰弹枪
